namespace MangaUnhost {
    partial class Main {
        ...
        private void InitializeComponent() {
			...
			this.StatusBar = new MangaUnhost.VSStatusBar();
			this.MainTabMenu = new MangaUnhost.VSTabControl();
			this.DownloaderTab = new System.Windows.Forms.TabPage();
			this.ContainerScrollBar = new MangaUnhost.VSVerticalScrollBar();
			...
			this.LinksListBox = new MangaUnhost.VSListBoxWBuiltInScrollBar();
			this.CrawlerCopyBtn = new MangaUnhost.VSButton();
			this.lblRegex = new System.Windows.Forms.Label();
			this.tbCrawlerRegex = new MangaUnhost.VSNormalTextBox();
			this.CrawlerStartBtn = new MangaUnhost.VSButton();
			this.lblUrl = new System.Windows.Forms.Label();
			this.tbCrawlerUrl = new MangaUnhost.VSNormalTextBox();
			this.SettingsTab = new System.Windows.Forms.TabPage();
			this.FeaturesGroupBox = new MangaUnhost.VSGroupBox();
			this.btnSetupComparsion = new MangaUnhost.VSButton();
			...
			this.EnvironmentGroupBox = new MangaUnhost.VSGroupBox();
			this.lblLanguage = new System.Windows.Forms.Label();
			this.LanguageBox = new MangaUnhost.VSComboBox();
			this.bntLibSelect = new MangaUnhost.VSButton();
			this.LibraryPathTBox = new MangaUnhost.VSNormalTextBox();
			this.lblLibrary = new System.Windows.Forms.Label();
			this.AboutTab = new System.Windows.Forms.TabPage();
			this.SupportedHostsBox = new MangaUnhost.VSGroupBox();
			this.SupportedHostListBox = new MangaUnhost.VSListBoxWBuiltInScrollBar();
			this.lblCredits = new System.Windows.Forms.Label();
			this.lblTitle = new System.Windows.Forms.Label();
			this.DebugTab = new System.Windows.Forms.TabPage();
			this.dbgTranslate = new MangaUnhost.VSButton();
			this.dbgBrowser = new MangaUnhost.VSButton();
			this.dbgButtonC = new MangaUnhost.VSButton();
			this.dbgButtonB = new MangaUnhost.VSButton();
			this.DbgButtonA = new MangaUnhost.VSButton();
			...
			this.ThemeContainer.FormOrWhole = MangaUnhost.VSContainer.@__FormOrWhole.Form;
			...
			// StatusBar
			// 
			this.StatusBar.AmountOfString = MangaUnhost.VSStatusBar.AmountOfStrings.Two;
			...
			this.StatusBar.ThirdLabelAlignment = MangaUnhost.VSStatusBar.Alignments.Right;
			...
			// ContainerScrollBar
			// 
			this.ContainerScrollBar.AmountOfInnerLines = MangaUnhost.VSVerticalScrollBar.@__InnerLineCount.None;
			...
			this.LinksListBox.Items = new MangaUnhost.VSListBoxWBuiltInScrollBar.VSListBoxItem[0];
			...
			this.CrawlerCopyBtn.ImageAlignment = MangaUnhost.VSButton.@__ImageAlignment.Left;
			...
			this.tbCrawlerRegex.Style = MangaUnhost.VSNormalTextBox.Styles.NotRounded;
			...
			this.CrawlerStartBtn.ImageAlignment = MangaUnhost.VSButton.@__ImageAlignment.Left;
			...
			this.tbCrawlerUrl.Style = MangaUnhost.VSNormalTextBox.Styles.NotRounded;
			...
			this.FeaturesGroupBox.Controls.Add(this.btnSetupComparsion);
			...
			// btnSetupComparsion
			// 
			this.btnSetupComparsion.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.btnSetupComparsion.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(45)))), ((int)(((byte)(45)))), ((int)(((byte)(48)))));
			this.btnSetupComparsion.BaseColour = System.Drawing.Color.FromArgb(((int)(((byte)(45)))), ((int)(((byte)(45)))), ((int)(((byte)(48)))));
			this.btnSetupComparsion.BorderColour = System.Drawing.Color.FromArgb(((int)(((byte)(15)))), ((int)(((byte)(15)))), ((int)(((byte)(18)))));
			this.btnSetupComparsion.FontColour = System.Drawing.Color.FromArgb(((int)(((byte)(153)))), ((int)(((byte)(153)))), ((int)(((byte)(153)))));
			this.btnSetupComparsion.HoverColour = System.Drawing.Color.FromArgb(((int)(((byte)(60)))), ((int)(((byte)(60)))), ((int)(((byte)(62)))));
			this.btnSetupComparsion.ImageAlignment = MangaUnhost.VSButton.@__ImageAlignment.Left;
			this.btnSetupComparsion.ImageChoice = null;
			this.btnSetupComparsion.Location = new System.Drawing.Point(586, 271);
			this.btnSetupComparsion.Name = "btnSetupComparsion";
			this.btnSetupComparsion.ShowBorder = true;
			this.btnSetupComparsion.ShowImage = false;
			this.btnSetupComparsion.ShowText = true;
			this.btnSetupComparsion.Size = new System.Drawing.Size(227, 23);
			this.btnSetupComparsion.TabIndex = 15;
			this.btnSetupComparsion.Text = "Text Detection Tuning";
			this.btnSetupComparsion.TextAlignment = System.Drawing.StringAlignment.Center;
			this.btnSetupComparsion.Click += new System.EventHandler(this.btnSetupComparsion_Click);
			// 
			// panel10
			// 
			...
			this.bntLibSelect.ImageAlignment = MangaUnhost.VSButton.@__ImageAlignment.Left;
			...
			this.LibraryPathTBox.Style = MangaUnhost.VSNormalTextBox.Styles.NotRounded;
			...
			this.SupportedHostListBox.Items = new MangaUnhost.VSListBoxWBuiltInScrollBar.VSListBoxItem[0];
			...
			this.dbgTranslate.ImageAlignment = MangaUnhost.VSButton.@__ImageAlignment.Left;
			...
			// dbgBrowser
			// 
			this.dbgBrowser.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this.dbgBrowser.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(45)))), ((int)(((byte)(45)))), ((int)(((byte)(48)))));
			this.dbgBrowser.BaseColour = System.Drawing.Color.FromArgb(((int)(((byte)(45)))), ((int)(((byte)(45)))), ((int)(((byte)(48)))));
			this.dbgBrowser.BorderColour = System.Drawing.Color.FromArgb(((int)(((byte)(15)))), ((int)(((byte)(15)))), ((int)(((byte)(18)))));
			this.dbgBrowser.FontColour = System.Drawing.Color.FromArgb(((int)(((byte)(153)))), ((int)(((byte)(153)))), ((int)(((byte)(153)))));
			this.dbgBrowser.HoverColour = System.Drawing.Color.FromArgb(((int)(((byte)(60)))), ((int)(((byte)(60)))), ((int)(((byte)(62)))));
			this.dbgBrowser.ImageAlignment = MangaUnhost.VSButton.@__ImageAlignment.Left;
			this.dbgBrowser.ImageChoice = null;
			this.dbgBrowser.Location = new System.Drawing.Point(397, 35);
			this.dbgBrowser.Name = "dbgBrowser";
			this.dbgBrowser.ShowBorder = true;
			this.dbgBrowser.ShowImage = false;
			this.dbgBrowser.ShowText = true;
			this.dbgBrowser.Size = new System.Drawing.Size(92, 23);
			this.dbgBrowser.TabIndex = 4;
			this.dbgBrowser.Text = "Dbg Browser";
			this.dbgBrowser.TextAlignment = System.Drawing.StringAlignment.Center;
			this.dbgBrowser.Click += new System.EventHandler(this.dbgBrowser_Click);
			// 
			// dbgButtonC
			// 
			...
			this.dbgButtonC.ImageAlignment = MangaUnhost.VSButton.@__ImageAlignment.Left;
			...
			this.dbgButtonB.ImageAlignment = MangaUnhost.VSButton.@__ImageAlignment.Left;
			...
			this.DbgButtonA.ImageAlignment = MangaUnhost.VSButton.@__ImageAlignment.Left;
