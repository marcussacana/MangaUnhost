...
namespace MangaUnhost {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e) {
            ...
            switch (State) {
                case MouseState.None:
                    ...
                    G.DrawString("0", new Font("Marlett", 11, FontStyle.Regular), new SolidBrush(Color.FromArgb(221, 221, 221)), MinimizeRect.Width - 22, MinimizeRect.Height - 18);
                    ...
                    G.DrawString("r", new Font("Marlett", 11, FontStyle.Regular), new SolidBrush(Color.FromArgb(221, 221, 221)), CloseRect.Width - 7, CloseRect.Height - 16);
                    break;
    ...
    internal class iTalk_Label : Label {
            ...
            for (int TabIndex = 0; TabIndex <= TabCount - 1; TabIndex++) {
                if (TabIndex == SelectedIndex) {
                    ...
                    if (this.ImageList != null) {
                        ...
                        if (!(Index == -1)) {
                            _Graphics.DrawImageUnscaled(ImageList.Images[TabPages[TabIndex].ImageIndex], TabRect.X + 9, TabRect.Y + 6, 24, 24);
                        }
                    }
                } else {
                    Rectangle TabRect = new Rectangle(new Point(GetTabRect(TabIndex).Location.X - 2, GetTabRect(TabIndex).Location.Y - 2), new Size(GetTabRect(TabIndex).Width + 3, GetTabRect(TabIndex).Height - 8));
